...
space = Space.new(name: "Science Museum", description: Faker::Lorem.sentence(word_count: 10), address:"195 Hackney Rd, London E2 8JL",
...
space = Space.new(name:"Huge office space", description: Faker::Lorem.sentence(word_count: 10), address: "7 Boundary St, London E2 7JE", price_per_day: "")
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save

file = URI.open("https://www.tagvenue.com/blog/wp-content/uploads/2016/10/Devonshire-Terrace-01.jpg")
space = Space.new(name: "Beautiful wedding venue", description: Faker::Lorem.sentence(word_count: 10), address: "136 Kingsland Rd, London E2 8EA", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save

file = URI.open("https://www.peerspace.com/resources/wp-content/uploads/2018/05/vfhik8o2ifudxhhvxhfn.jpg")
space = Space.new(name: "Meeting room", description: Faker::Lorem.sentence(word_count: 10), address: "Falkirk St, London N1 6HQ", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save
...
space = Space.new(name: "Studious lecture hall", description: Faker::Lorem.sentence(word_count: 10), address: "49 Hackney Rd, London E2 7NX", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save

file = URI.open("https://www.paintworksbristol.co.uk/fileadmin/user_upload/Evoke-Event-Space_096_1200.jpg")
space = Space.new(name: "Ultimate party palace", description: Faker::Lorem.sentence(word_count: 10), address: "151-157 City Rd, London EC1V 1JH", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save

file = URI.open("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPH-SdVpErAodvRZU-j33sZgZkuw8bnwYNiw&usqp=CAU")
space = Space.new(name: "Bat mitzvah paradise", description: Faker::Lorem.sentence(word_count: 10), address: "119 St Peter's St, London N1 8PZ", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save

file = URI.open("https://www.socialtables.com/wp-content/uploads/2018/06/5-1.jpg")
space = Space.new(name: "Uber cool creative space", description: Faker::Lorem.sentence(word_count: 10), address: "The Trafford Centre, Trafford Park, Stretford, Manchester M17 8AA", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save
...
space = Space.new(name: "100% virtual zone", description: Faker::Lorem.sentence(word_count: 10), address: "Liverpool Rd, Manchester M3 4FP", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save
...
space = Space.new(name: "Beautiful garden space", description: Faker::Lorem.sentence(word_count: 10), address: "Salford Lads' Club, Coronation St, Salford M5 3SA", price_per_day: rand(10..500), user: User.first)
space.photos.attach(io: file, filename: "nes.png", content_type: "image/jpg")
space.save
